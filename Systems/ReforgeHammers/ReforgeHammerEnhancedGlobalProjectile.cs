...
namespace FaeReforges.Systems.ReforgeHammers {
    internal class ReforgeHammerEnhancedGlobalProjectile : GlobalProjectile {
        ...
        public override void ModifyHitNPC(Projectile projectile, NPC target, ref NPC.HitModifiers modifiers) {
            createdByItem?.GetGlobalItem<ReforgeHammerEnhancedGlobalItem>().GetHammer()?.changeWeaponDealDamageNpc(createdByItem, Main.player[projectile.owner], target, modifiers);
        }

        public override void ModifyHitPlayer(Projectile projectile, Player target, ref Player.HurtModifiers modifiers) {
            createdByItem?.GetGlobalItem<ReforgeHammerEnhancedGlobalItem>().GetHammer()?.changeWeaponDealDamagePvp(createdByItem, Main.player[projectile.owner], target, modifiers);
        }
