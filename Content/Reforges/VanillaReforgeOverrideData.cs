...
namespace FaeReforges.Content.Reforges {
    public class VanillaReforgeOverrideData {
        ...
        public VanillaReforgeOverrideData(int tier, float damage, float knockback, float speed, float size, float velocity, float mana, int crit) {
            this.tier = tier;
